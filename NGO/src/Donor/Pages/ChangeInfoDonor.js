  ...
  return (
    <div className="max-w-screen-lg mx-auto p-6 bg-white rounded-md shadow-md">
      ...
      <form onSubmit={handleSubmit} className="grid grid-cols-2 gap-6">
        ...
        <div>
          ...
          <div className="flex items-center">
            ...
            {!editableFields.organizationName && (
              <AiOutlineEdit
                onClick={() => handleEditField("organizationName")}
                className="ml-2 cursor-pointer"
              />
            )}
          </div>
        ...
        <div>
          <label className="block mb-1" htmlFor="organizationType">
            Organization Type
          </label>
          <div className="flex items-center">
            <input
              ...
              onChange={handleChange}
              className="input"
              disabled={!editableFields.organizationType}
            />
            {!editableFields.organizationType && (
              <AiOutlineEdit
                onClick={() => handleEditField("organizationType")}
                className="ml-2 cursor-pointer"
              />
            )}
          </div>
