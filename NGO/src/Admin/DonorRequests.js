      ...
      <table className="w-full table-auto bg-white text-black-900 -collapse   mt-10">
        ...
        <tbody>
          {donorRequests.map((donor) => (
            <tr key={donor.id} className="-t ">
              <td className="  px-4 py-2">{donor.firstName}</td>
              <td className="  px-4 py-2">{donor.lastName}</td>
              <td className="  px-4 py-2">{donor.gender}</td>
              <td className="  px-4 py-2">{donor.email}</td>
              <td className="  px-4 py-2">{donor.contactNumber}</td>
              <td className="  px-4 py-2 flex justify-between">
                <div className="flex space-x-4">
                  ...
                  <button
                    onClick={() => handleAcceptDonor(donor.id)}
