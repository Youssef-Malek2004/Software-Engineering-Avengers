...
const Organization = () => {
  ...
  const [filters, setFilters] = useState({ area: '', governorate: '', type: '' });
  const [organizations, setOrganizations] = useState([
    { id: 1, name: 'Organization 1', area: 'Area 1', governorate: 'Governorate 1', type: 'Type 1' },
    { id: 2, name: 'Organization 2', area: 'Area 2', governorate: 'Governorate 2', type: 'Type 2' },
    { id: 3, name: 'Organization 3', area: 'Area 3', governorate: 'Governorate 3', type: 'Type 3' },
    { id: 4, name: 'Organization 4', area: 'Area 4', governorate: 'Governorate 4', type: 'Type 4' },
    { id: 5, name: 'Organization 5', area: 'Area 5', governorate: 'Governorate 5', type: 'Type 5' },
    { id: 6, name: 'Organization 6', area: 'Area 1', governorate: 'Governorate 2', type: 'Type 3' },
    { id: 7, name: 'Organization 7', area: 'Area 2', governorate: 'Governorate 3', type: 'Type 4' },
    { id: 8, name: 'Organization 8', area: 'Area 3', governorate: 'Governorate 4', type: 'Type 5' },
  ]);
  ...
  const filteredOrganizations = organizations.filter(org => {
    const matchName = org.name.toLowerCase().includes(searchQuery.toLowerCase());
    const matchArea = filters.area ? org.area === filters.area : true;
    const matchGovernorate = filters.governorate ? org.governorate === filters.governorate : true;
