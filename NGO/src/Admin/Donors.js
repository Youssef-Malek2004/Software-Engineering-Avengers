...
const Donors = () => {
  ...
  const filteredDonors = donors.filter((donor) => {
    ...
    const matchProfession = filters.profession
      ? donor.profession === filters.profession
      : true;
  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <table className="w-full table-auto bg-white text-black-900 ">
        <thead>
          <tr
